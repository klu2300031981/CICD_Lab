...
class Donor extends Component {
    ...
    componentDidMount() {
        callApi("GET", `${API_URL}/donors/readdonor`, "", this.readDonorResponse);
    }
    ...
    saveDonorDetails = () => {
        ...
        if (this.state.id === "") {
            callApi("POST", `${API_URL}/donors/insert`, data, this.saveDonorResponse);
        } else {
            callApi("PUT", `${API_URL}/donors/update`, data, this.saveDonorResponse);
        }
    }
    ...
    updateDonor(id) {
        callApi("GET", `${API_URL}/donors/getdonor/` + id, "", this.updateDonorresponse);
    }
    ...
    deleteDonor(id) {
        ...
        if (!resp) return;
        callApi("DELETE", `${API_URL}/donors/delete/` + id, "", this.saveDonorResponse);
    }

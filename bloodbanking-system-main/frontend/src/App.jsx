...
class App extends Component {
    ...
    userRegistrtaion()
    {
        ...
        callApi("POST",`${API_URL}/users/signup`,data,this.getResponse);
    ...
    forgetpassword()
    {
        ...
        let url=`${API_URL}/users/forgetpassword/`+username.value;
    ...
    signin()
    {
        ...
        callApi("POST", `${API_URL}/users/signin`, data, this.signinResponse);
    }
    signinResponse(res)
    {
        let rdata = res.split('::');
